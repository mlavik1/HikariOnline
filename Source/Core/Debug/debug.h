...
#define LOG(level) \
	Hikari::Debug(level, __FILE__,__LINE__)
#define LOG_INFO() \
	Hikari::Debug(DEBUG_MODE_INFO, __FILE__,__LINE__)
#define LOG_WARNING() \
	Hikari::Debug(DEBUG_MODE_WARNING, __FILE__,__LINE__)
#define LOG_ERROR() \
	Hikari::Debug(DEBUG_MODE_ERROR, __FILE__,__LINE__)
#define LOG_EXCEPTION() \
	Hikari::Debug(DEBUG_MODE_EXCEPTION, __FILE__,__LINE__)
